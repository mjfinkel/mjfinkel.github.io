<html>
  ...
  <body>
    <div>
      <h2>About Me</h2>
      <p>I am a college student from the Chicagoland area currently studying computer science as an undergraduate at the University of Michigan. I am also an experienced videographer with a demonstrated history of working in the newspaper industry and for my school. I am currently looking for a software related internship for the summer 2024 season.</p>
      <p>I have always been interested in computers. As I kid, I wanted to create a mod and my own server for my favorite game Minecraft. I started taking classes in 2019 during my Junior year of High School. Since then, I have not gone a semester without taking a computer science course. I have always wanted to broaden my interests as a student and learn as much as possible about the many different paths I can take as a computer scientist.</p>
      <p>In middle school, my best friend and I always took the optional route of creating a video narrative for class projects instead of in-class presentations for Spanish class. We created stories with characters, added our current favorite songs, and hid easter eggs for the other students to find in our videos. Before my freshman year of high school, I had already met the high school film teacher and knew I would be taking her classes for the next four years. I created a very close relationship with my teacher and made countless projects for my school's film program and course, later becoming a station manager--the highest leadership position within the program. After graduating high school I went on to create video for The Michigan Daily for two years.</p>
    </div>
    <div>
      <h2>Education</h2>
      <p>
