<html>
  ...
  <body>
    <div>
      ...
      <p>From a young age, I was always interested in computers. I always wanted to create a mod and my own server for my favorite game Minecraft. I started taking classes in 2019 during my Junior year of High School. Since then, I have not gone a semester without taking a course on computer science. I have always wanted to broaden my interests as a student and learn as much as possible about the many different paths I can take as a computer scientist.</p>
      <p>My interest in video also started at a young age. Since middle school, my best friend and I always took the optional route of creating a video narrative for class projects instead of in-class presentations for Spanish class. We created stories with characters, added our current favorite songs, and hid easter eggs for the other students to find in our videos. Before my freshman year of high school, I had already met the high school film teacher and knew I would be taking her classes for the next four years. I created a very close relationship with my teacher and made countless projects for my school's film program and course, later becoming a station manager--the highest leadership position within the program. After graduating high school I went on to create video for The Michigan Daily.</p>
    </div>
    <div>
      <h2>Education</h2>
      <p>
